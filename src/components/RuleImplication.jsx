  ...
  return (
    <>
      ...
      <div className="border rounded-lg px-4 py-4 mb-4 shadow-md">
        ...
        <div className="text-gray-600 mt-4">α-predikat-2</div>
        <div className="text-gray-800 font-semibold">{item.rule2Result}</div>
        <div className="text-gray-600 mt-4">z-2</div>
      ...
      <div className="border rounded-lg px-4 py-4 mb-4 shadow-md">
        ...
        <div className="text-gray-600 mt-4">α-predikat-3</div>
        <div className="text-gray-800 font-semibold">{item.rule3Result}</div>
        <div className="text-gray-600 mt-4">z-3</div>
      ...
      <div className="border rounded-lg px-4 py-4 mb-4 shadow-md">
        ...
        <div className="text-gray-600 mt-4">Aturan</div>
        <div className="text-gray-800 font-medium">
          Jika permintaan turun dan persediaan banyak, maka produksi = 0.5 x
          persediaan - permintaan
        </div>
        <div className="text-gray-600 mt-4">α-predikat-4</div>
        <div className="text-gray-800 font-semibold">{item.rule4Result}</div>
        <div className="text-gray-600 mt-4">z-4</div>
